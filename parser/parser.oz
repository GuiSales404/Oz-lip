declare fun {IsIdent X} {IsAtom X} end
declare fun {Id S1 Sn} X in S1=X|Sn true={IsIdent X} X end

declare fun {Sequence NonTerm Sep S1 Sn}
  X1 S2 T S3 in
  X1={NonTerm S1 S2}
  S2=T|S3
  if {Sep T} then X2 in
